...
/* Function to read keypress from user side and publish to topic "/key_press"
 * Current functionality is simplistic. Use Arrow keys to move the AGV, "Space" to stop it and Q to quit the program
 * To be run on the client computer
 * Same program can be redesigned to use input from any other device and provide same values to be published to topic
 */
