...
/* Alternate to TeleOp_Server and TeleOp_Client
 * This function reads values published to topic "/key_press" and moves the AGV accordingly
 * Simplistic but more than one device can be used at the same time, hence caution is advised when using
 */
